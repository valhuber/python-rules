...
| ------------- | ------------- | --------- |
| **Conciseness**  | 5 spreadsheet-like rules implement the check-credit requirement shown below | The same logic requires 200 hundred of lines of code (see explore, below)|
| **Performance** | SQLs are pruned and minimized (example below)| Optimizations require hand-code |
