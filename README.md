...
| ------------- | ------------- | --------- |
| **Conciseness**  | **5 spreadsheet-like rules** implement the check-credit requirement (shown below) | The same logic requires **200 hundred of lines** of code [(shown here)](https://github.com/valhuber/python-rules/wiki/by-code).  <br><div class="text-red">
  This represents a **40X** reduction in the backend half of a transactional database system.</div>|
